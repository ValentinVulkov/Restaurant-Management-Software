...
int checkRole()
{
    ...
    if (role == 1) {
        ...
        std::cout << "Invalid role! Please enter 1 for Waiter or 2 for Manager."<< "\n";
        return -1;
    }
}
void waiterOptions()
{
    while (true)
    {
        ...
        switch (chosenOption)
        {
        case 1: showAllActionsWaiter(); break;
        ...
        case 8: exit(0); break;
        default: std::cout << "Not an avalable option."; waiterOptions(); break;
        }
    }
}
void managerOptions()
